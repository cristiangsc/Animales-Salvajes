     ...
     if (animalSelect.value === "Seleccione un animal") {
         ...
         try {
             ...
             if (animalSelect.value == "Leon") {
                 newAnimal = new Leon(animalSelect.value, edadId.value, `/Animales-Salvajes/blob/master/assets/imgs/${imagenAnimal}`, comentariosId.value, `/Animales-Salvajes/blob/master/assets/sounds/${sonidoAnimal}`);
             }
             if (animalSelect.value == "Lobo") {
                 newAnimal = new Lobo(animalSelect.value, edadId.value, `/Animales-Salvajes/blob/master/assets/imgs/${imagenAnimal}`, comentariosId.value, `/Animales-Salvajes/blob/master/assets/sounds/${sonidoAnimal}`);
             }
             if (animalSelect.value == "Oso") {
                 newAnimal = new Oso(animalSelect.value, edadId.value, `/Animales-Salvajes/blob/master/assets/imgs/${imagenAnimal}`, comentariosId.value, `/Animales-Salvajes/blob/master/assets/sounds/${sonidoAnimal}`);
             }
             if (animalSelect.value == "Serpiente") {
                 newAnimal = new Serpiente(animalSelect.value, edadId.value, `/Animales-Salvajes/blob/master/assets/imgs/${imagenAnimal}`, comentariosId.value, `/Animales-Salvajes/blob/master/assets/sounds/${sonidoAnimal}`);
             }
             if (animalSelect.value == "Aguila") {
                 newAnimal = new Aguila(animalSelect.value, edadId.value, `/Animales-Salvajes/blob/master/assets/imgs/${imagenAnimal}`, comentariosId.value, `/Animales-Salvajes/blob/master/assets/sounds/${sonidoAnimal}`);
             }
 ...
 const limpiarFor = () => { // funcion para setear los select, comentarios y el preview del animal
     ...
     document.querySelector("#preview").style.backgroundImage = "/Animales-Salvajes/blob/master/assets/imgs/lion.svg";
 };
 ...
 (() => { // funcion anominma que escucha los comabio del select animal, luego consulta el json, y genera el preview del animal seleccionado cada vez que cambia la seleccion el usuario.
     animalSelect.addEventListener("change", async(Animal) => {
         ...
         previewId.innerHTML = `<img class="previewAnimal"  src="/Animales-Salvajes/blob/master/assets/imgs/${imagen}" />`;
     });
 })();
